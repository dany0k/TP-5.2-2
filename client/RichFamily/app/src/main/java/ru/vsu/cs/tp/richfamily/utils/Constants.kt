...
object Constants {
    ...
    const val ONLY_LETTERS = "Данное поле может содержать только буквы!"
    const val SECRET_VALID = "Секретное слово должно содержать только буквенные символы и цифры!"
    const val MAX_LENGHT_ERR_45 = "Максимальная длинна поля 45 символов!"
    const val MAX_LENGHT_ERR_20 = "Максимальная длинна поля 20 символов!"
    const val MAX_LENGHT_ERR_9 = "Максимальная длинна поля 9 символов!"
    const val MIN_LENGHT_ERR_8 = "Минимальная длинна поля 8 символов!"
    const val SUCCESS = "Успешно!"
    const val FIRSTPAY_BT_SUM = "Первоначальный взнос не может быть больше чем сумма кредита!"
    ...
    const val PWD_INVALID = "Пароль должен содержать не менее 8 символов и не более 45, как минимум одну заглавную, строчную букву и цифру!"
